package com.hyozu.example.ems_patient.ui.home;
...
import com.hyozu.example.ems_patient.Callback.IFirebaseDriverInfoListener;
import com.hyozu.example.ems_patient.Callback.IFirebaseFailedListener;
...
import com.hyozu.example.ems_patient.Model.DriverInfoModel;
import com.hyozu.example.ems_patient.Model.EventBus.SelectePlaceEvent;
import com.hyozu.example.ems_patient.Model.GeoQueryModel;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback, IFirebaseFailedListener, IFirebaseDriverInfoListener {
    ...
    DatabaseReference onlineRef, currentPatientRef, driversLocationRef;
    GeoFire geoFire;


    //Load Driver
    private double distance = 10.0; //default Kilometer
    private static final double LIMIT_RANGE = 15.0; // range
    private Location previousLocation, currentLocation; // use of calculate distance
                ...
                .addOnSuccessListener(location -> {
                    ...
                    try {
                        ...
                        if (!TextUtils.isEmpty(cityName)) {
                            ...
                            //Listen new driver in city and range
                            driver_location_ref.addChildEventListener(new ChildEventListener() {
                                ...
                                public void onChildAdded(@NonNull DataSnapshot datasnapshot, @Nullable String previousChildName) {
                                    ...
                                    float newDistance = location.distanceTo(newDriverLocation) / 1000; //in kilometer
                ...
                else
                {
                    if (Common.markerList.get(driverGeoModel.getKey()) != null)
                    {
                        ...
                        if (Common.driverLocationSubscribe.get(driverGeoModel.getKey()) != null)
                        {
                            ...
                            AnimationModel oldPostition = Common.driverLocationSubscribe.get(driverGeoModel.getKey());

                            String from = new StringBuilder()
                                    .append(oldPostition.getGeoQueryModel().getL().get(0))
                                    .append(",")
